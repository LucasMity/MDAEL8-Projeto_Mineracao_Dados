...
def load_dataset(dataset='loan'):        
    if dataset == 'iris':
        ...
        features_names = ['Gender', 'Married', 'Dependents', 'Education', 'Self_Employed', 'Applicant_Income', 'Coapplicant_Income', 'Loan_Amount', 'Term','Credit_History', 'Area', 'Status']
        target = 'Status'
        df = pd.read_csv(input_file,    # Nome do arquivo com dados
                        names = features_names) # Nome das colunas
...
def main():
    #load dataset
    target_names, df = load_dataset('loan')
