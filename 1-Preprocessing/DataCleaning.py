...
def main():
    ...
    features = ['SFH','PopUpWindow','SSLfinal_State','Request_URL','URL_of_Anchor','web_traffic', 'URL_Length', 'age_of_domain', 'having_IP_Address', 'Result'] 
    output_file = '0-Datasets/PhishingClear.data'
